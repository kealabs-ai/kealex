...
export function IAPage() {
  ...
  return (
    <div className="flex flex-col h-screen mesh-bg dark:bg-transparent">
      <TopBar
        icon={Sparkles}
        title="Kealex AI Hub"
            ...
            {messages.length === 0 ? (
              ...
              >
                ...
                <div className="text-center mb-8">
                  <div className="w-16 h-16 rounded-3xl bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center mx-auto mb-4 shadow-xl shadow-indigo-200 dark:shadow-indigo-950/40">
                    ...
                    {SUGGESTED_PROMPTS.map((s) => (
                      <motion.button
                        ...
                        className={`flex items-start gap-3 p-3.5 border rounded-2xl text-left transition-all group ${
                          hasConfig
                            ? 'bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-indigo-200 dark:hover:border-indigo-500/30 hover:shadow-sm hover:shadow-indigo-100 dark:hover:shadow-indigo-950/40'
                ...
                <AnimatePresence initial={false}>
                  {messages.map((msg) => (
                    ...
                    >
                      {/* avatar */}
                      {msg.role === 'assistant' ? (
                        <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center shrink-0 shadow-md shadow-indigo-200 dark:shadow-indigo-950/40 mt-1">
